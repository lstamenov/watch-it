...
export const fetchShowExternalLinks = (id: number) =>
  axios.get(LOAD_SHOW_EXTERNAL_LINKS(id, i18n.language));
...
export const fetchMovieRecommendations = (id: number) =>
  axios.get(LOAD_MOVIE_RECOMMENDATIONS(id, i18n.language));
export const fetchSimilarShows = (id: number) => axios.get(LOAD_SIMILAR_SHOWS(id, i18n.language));
export const fetchShowRecommendations = (id: number) =>
  axios.get(LOAD_SHOW_RECOMMENDATIONS(id, i18n.language));
