...
export const TRENDING_DAILY_MOVIES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/movie/day?api_key=${API_KEY}&language=${lang}&page=`;
export const TRENDING_WEEKLY_MOVIES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/movie/week?api_key=${API_KEY}&language=${lang}&page=`;
export const POPULAR_MOVIES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/movie/popular?api_key=${API_KEY}&language=${lang}&page=`;
export const LATEST_MOVIES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/movie/latest?api_key=${API_KEY}&language=${lang}&page=`;
export const UPCOMING_MOVIES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/movie/upcoming?api_key=${API_KEY}&language=${lang}&page=`;
...
export const MOVIE_CAST_URL = (id: number, lang: string) =>
  `https://api.themoviedb.org/3/movie/${id}/credits?api_key=${API_KEY}&language=${lang}`;

export const POPULAR_SHOWS_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/tv/popular?api_key=${API_KEY}&language=${lang}&page=1`;
export const TOP_RATED_SHOWS_URL = (lang: string): string =>
...
export const MOVIE_GENRES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/genre/movie/list?api_key=${API_KEY}&language=${lang}`;
export const TV_GENRES_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/genre/tv/list?api_key=${API_KEY}&language=${lang}`;

export const TRENDING_DAILY_TV = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/tv/day?api_key=${API_KEY}&language=${lang}`;
export const TRENDING_WEEKLY_TV = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/tv/day?api_key=${API_KEY}&language=${lang}`;
export const TRENDING_DAILY = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/all/day?api_key=${API_KEY}&language=${lang}`;
export const TRENDING_WEEKLY = (lang: string): string =>
  `https://api.themoviedb.org/3/trending/all/week?api_key=${API_KEY}&language=${lang}`;
export const MORE_TRENDING_WEEKLY = (lang: string): string =>
...
export const LOAD_SEASON = (showId: number, seasonNumber: number, lang: string) =>
  ` https://api.themoviedb.org/3/tv/${showId}/season/${seasonNumber}?api_key=${API_KEY}&language=${lang}`;
...
export const SHOW_GENRE_RESULTS_URL = (lang: string): string =>
  `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&language=${lang}&sort_by=popularity.desc&include_adult=false&page=1&with_genres=`;
export const LOAD_MORE_MOVIE_GENRE_RESULTS = (page: number, lang: string) =>
  `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=${lang}&sort_by=popularity.desc&include_adult=false&page=${page}&with_genres=`;
export const LOAD_MORE_SHOW_GENRE_RESULTS = (page: number, lang: string) =>
  `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&language=${lang}&sort_by=popularity.desc&include_adult=false&page=${page}&with_genres=`;
...
export const SHOW_TRAILER_URL = (id: number, lang: string) =>
  `https://api.themoviedb.org/3/tv/${id}/videos?api_key=${API_KEY}&language=${lang}`;
export const SHOW_CAST_URL = (id: number, lang: string) =>
  `https://api.themoviedb.org/3/tv/${id}/credits?api_key=${API_KEY}&language=${lang}`;
